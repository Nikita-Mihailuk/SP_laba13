...
public class Main {
    ...
    public static String getExtension(byte[] header) {
        ...
        Extensions.put("FF D8 FF", ".jpg");  // JPEG
        Extensions.put("89 50 4E", ".png");  // PNG
        Extensions.put("49 44 33", ".mp3");  // MP3
        Extensions.put("25 50 44", ".pdf");  // PDF
        Extensions.put("00 00 00", ".mp4");  // MP4
        Extensions.put("50 4B 03", ".docx"); // DOCX
        ...
        // Преобразуем в строку для дальнейшей работы
        String str = sb.toString().trim();

        // Возвращаем расширение, если нашли соответствие
